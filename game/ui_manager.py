...
class UIManager:
    ...
    def _create_main_container(self):
        ...
        # Create a semi-transparent frame for UI
    ...
    def _create_header(self):
        ...
        self.header_frame.configure(border_width=1, border_color="#00F0FF")  
        ...
        self.mines_frame.configure(border_width=1, border_color="#00F0FF")  #
        ...
        self.flags_frame.configure(border_width=1, border_color="#FF00FF")  
        ...
        self.timer_frame.configure(border_width=1, border_color="#00F0FF")  
    ...
    def _create_status_bar(self):
        ...
        self.status_frame.configure(border_width=1, border_color="#00F0FF")  
    ...
    def calculate_cell_size(self, rows, cols):
        ...
        screen_height = self.root.winfo_screenheight() - 350  
