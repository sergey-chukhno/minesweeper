...
class GridManager:
    ...
    def initialize_mines(self, first_click_row, first_click_col):
        ...
        # First, flatten the grid for easier manipulation
    ...
    def reveal_cell(self, row, col):
        ...
        if cell.is_mine:
            ...
            if cell.value > 0:
                ...
                # Add neon glow effect for numbers - ensure a valid font tuple
            ...
            # If cell has no surrounding mines
            if cell.value == 0:
                rows = self.game_logic.rows
                cols = self.game_logic.cols
